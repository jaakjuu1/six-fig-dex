...
contract('Dex', accounts => {
	...
	it('should NOT create a limit order if token does not exist', async () => {
		await expectRevert(
	...
	it('should create market orfer & match against existing limit order', async () =>{
		await dex.deposit(
			web3.utils.toWei('100'),
			DAI,
			{ from: trader1 }
	...
	it('should NOT create a market order if token does not exist', async () => {
		await expectRevert(
